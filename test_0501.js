...
function Cron_Scheduler(date_str,dataUrl,socket) {
  return new Promise((resolve,reject)=>{
...
function  main(socket){
  ...
  Cron_Scheduler('46 */1 * * *',timeDataUrl,socket); // 단기 예보
  Cron_Scheduler('11 2,5,8,11,17,20,23 * * *',spaceDataUrl,socket); // 동네 예보
